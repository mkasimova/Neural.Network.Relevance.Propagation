...
logger = logging.getLogger("featureExtr")


class FeatureExtractor(object):

    def __init__(self, samples, labels=None, scaling=True, n_splits=20, name=None):
        # Setting parameters
    ...
    def extract_features(self):
        ...
        for i_iter in range(self.n_splits):
            ...
            if self.labels is not None:
                # Test classifier
                errors[i_iter] = utils.check_for_overfit(test_set, test_labels, model)
