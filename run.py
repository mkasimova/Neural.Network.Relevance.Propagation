...
### FEATURE EXTRACTION ###
n_iterations, n_splits = 10, 1 #Number of times to run and number of splits in cross validation
...
for i in range(len(methods)):
    ...
    axs[i].scatter(holo_feature1, holo_feature2, c='blue', label='Deprotonated')
    axs[i].scatter(apo_feature1, apo_feature2, c='red', label='Neutral')
